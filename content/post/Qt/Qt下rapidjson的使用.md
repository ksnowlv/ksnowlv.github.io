...
![image](/images/post/Qt下rapidjson的使用/rapidjson_overview.png)
...
![image](/images/post/Qt下rapidjson的使用/qt_cmakelists.png)
![image](/images/post/Qt下rapidjson的使用/qt_dir.png)
...
date: Tue, 19 Dec 2023 03:29:46 GMT
server: uvicorn
content-length: 31
...
生成的JSON字符串：{"name":"ksnowlv","age":0,"phone":"15210795183","verification_code":"123456"}
0x16eeca910
0x16eeca910
0x16eeca910
0x16eeca910
...
Response received:{"code":200,"message":"请求成功","data":{"userid":"382ac48a-4103-4123-8491-286432f28f28","token":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIzODJhYzQ4YS00MTAzLTQxMjMtODQ5MS0yODY0MzJmMjhmMjgiLCJleHAiOjE3MDU1NDg1ODZ9.4yV3MI8MQOVQ2--T2ptwYNSMr79BMic9ZalXumsxoKE"}}
返回的code: 200
返回的message: 请求成功
返回的userid: 382ac48a-4103-4123-8491-286432f28f28
返回的token: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIzODJhYzQ4YS00MTAzLTQxMjMtODQ5MS0yODY0MzJmMjhmMjgiLCJleHAiOjE3MDU1NDg1ODZ9.4yV3MI8MQOVQ2--T2ptwYNSMr79BMic9ZalXumsxoKE
```
